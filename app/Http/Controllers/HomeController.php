...
class HomeController extends Controller
{
    ...
    {
        $slider = Hotel::select('id','title', 'image','category_id','city','slug')->inRandomOrder()->limit(4)->get();
        $setting = Setting::first();
        $daily = Hotel::select('id','title', 'image','category_id','city','slug','address','country')->limit(3)->inRandomOrder()->get();
    ...
    public function sendrezerve(Request $request,$id)
    {
        ...
        $datetime1 = strtotime($data->checkin); // convert to timestamps
        $datetime2 = strtotime($data->checkout); // convert to timestamps
